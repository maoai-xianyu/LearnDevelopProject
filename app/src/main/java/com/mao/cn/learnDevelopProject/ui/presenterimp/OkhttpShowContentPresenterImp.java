...
import com.mao.cn.learnDevelopProject.utils.network.MyOKHttpFactoryU;
import com.mao.cn.learnDevelopProject.utils.network.NetworkUtils;
import com.mao.cn.learnDevelopProject.utils.network.OKHttpClientFactory;
...
public class OkhttpShowContentPresenterImp extends BasePresenterImp implements OkhttpShowContentPresenter {
    ...
    public void getMovieTopMyOkHttp(int start, int count) {
        ...
        clientFactory.okHttpGetMovieTop(LearnDevelopApplication.serverInfo().getServerHost() + "v2/movie/top250", params, new IResponseHandler() {
            @Override
