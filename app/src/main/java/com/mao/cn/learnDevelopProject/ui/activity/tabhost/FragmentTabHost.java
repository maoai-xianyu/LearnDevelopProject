...
/**
 * Special TabHost that allows the use of {@link Fragment} objects for its tab content.  When placing this in a view hierarchy,
 * after inflating the hierarchy you must call {@link #setup(Context, FragmentManager, int)} to complete the initialization of the
 * tab host.
 *
 * <p>Here is a simple example of using a FragmentTabHost in an Activity:
 * <p>
 * {@sample frameworks/support/samples/Support4Demos/src/com/example/android/supportv4/app/FragmentTabs.java complete}
 *
...
public class FragmentTabHost extends TabHost
    ...
    /**
     * @deprecated Don't call the original TabHost setup, you must instead call {@link #setup(Context, FragmentManager)} or {@link
    ...
    private void ensureContent() {
        if (mRealTabContent == null) {
            mRealTabContent = (LinearLayout) ((Activity) mContext)
                    .findViewById(mContainerId);//todo zhugejiao
            if (mRealTabContent == null) {
                throw new IllegalStateException(
    ...
    public void addTab(@NonNull TabHost.TabSpec tabSpec, @NonNull Class<?> clss,
        ...
        if (mAttached) {
            ...
            /*if (info.fragment != null && !info.fragment.isDetached()) {
                ...
                if (info.fragment instanceof VideoListFragment) {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            ...
            if (tab.fragment != null && !tab.fragment.isDetached()) {
                if (tab.tag.equals(currentTag)) {
                    ...
                    /*if (tab.fragment instanceof VideoListFragment) {
        ...
        if (mLastTab != newTab) {
            ...
            if (mLastTab != null) {
                if (mLastTab.fragment != null) {
                    /*if (mLastTab.fragment instanceof VideoListFragment) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    /*if (newTab.fragment instanceof VideoListFragment) {
