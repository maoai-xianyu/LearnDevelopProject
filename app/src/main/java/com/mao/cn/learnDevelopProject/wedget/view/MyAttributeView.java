...
public class MyAttributeView extends View {
    ...
    public MyAttributeView(Context context, @Nullable AttributeSet attrs) {
        ...
        // 获取属性三种方式
        // 1. 用命名空间获取 eclipes xmlns:define="http://schemas.android.com/apk/<包名>"   as    xmlns:app="http://schemas.android.com/apk/res-auto"
        ...
        LogU.d("方法一: age == " + age + ", name == " + name + ", bg == " + bg);

        // 2. 遍历属性集合
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
            LogU.d("方法二: name == " + attrs.getAttributeName(i) + ", value == " + attrs.getAttributeValue(i));
        }

        // 3. 使用系统工具，获取属性

        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MyAttributeView);
