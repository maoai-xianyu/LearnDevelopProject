...
public class ParallaxViewFragment extends BaseFragment implements LayoutInflater.Factory2 {
    ...
    public static ParallaxViewFragment newInstance(int layoutId) {
        ParallaxViewFragment fragment = new ParallaxViewFragment();
